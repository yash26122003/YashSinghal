    ...
    return (
        <section id="resume" className="wrapper">
            ...
            <div className='resume-pfp'>
                <img src={pfp} alt="Yash Singhal on all Socials" />
                <span className='pfp-text'>
                    <h1>@<span className="highlight">YashSinghalYS</span></h1>
                    <h2>on all socials</h2>
                    <h3>{time} IST</h3>
                    <p><span className="highlight">yashsinghal_</span> on discord</p>
                </span>
            </div>
...
<div class="parent">
        <div class="card">
            ...
            <div class="glass"></div>
            <div class="content">
            <a href="https://dulcet-malasada-c5f010.netlify.app/resume.pdf" target="_blank" rel="noopener noreferrer"><span class="title">Résumé</span></a>
                <span class="text">Create, Demonstrate, and publish</span>
            </div>
            <div class="bottom">
                ...
                <div class="social-buttons-container">
                    ...
                    <a href="https://www.instagram.com/yash.singhal.98892/" target="_blank" rel="noopener noreferrer">
                      ...
                      <a href="https://twitter.com/YashSinghal2612" target="_blank" rel="noopener noreferrer">
                      ...
                      <a href="https://discord.com/users/1163313790331387955" target="_blank" rel="noopener noreferrer">
                      ...
                      <button class="social-button .social-button4">
                      <a href="mailto:yashsinghal2612@gmail.com" target="_blank" rel="noopener noreferrer">
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 30 30" class="svg">
                        <path d="M2 4C2 3.44772 2.44772 3 3 3H27C27.5523 3 28 3.44772 28 4V26C28 26.5523 27.5523 27 27 27H3C2.44772 27 2 26.5523 2 26V4ZM3 5V25H27V5H3ZM3 5L15 14L27 5H3Z"></path>
                        </svg>
                        </a>
                      </button>

                      <button class="social-button .social-button5">
                      ...
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 30 30" class="svg">
                        <rect x="0" y="0" width="30" height="30" rx="5" />
                            <text x="50%" y="50%" font-size="12" text-anchor="middle" dy=".3em" fill="white" font-family="Arial, sans-serif">in</text>
                            </svg>
                        </a>
                        </button>
            ...
            {/* <div className='socials'>
                <a href="https://dulcet-malasada-c5f010.netlify.app/resume.pdf" target="_blank" rel="noopener noreferrer"><button>
                    <div className="side">
                    </div>
                    Résumé
                </button></a>
